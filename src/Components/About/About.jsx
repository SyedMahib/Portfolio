...
const About = () => {
  return (
    <section className="md:container mx-auto md:rounded-3xl bg-gradient-to-br from-gray-950 via-blue-900/10 to-gray-950 text-white py-16 px-6 md:px-20 mb-10 ">
      <h2 data-aos="fade-down" className="text-3xl font-bold mb-8 text-center">
        <span className="text-blue-500">//</span> About Me
      </h2>

      <div className="flex flex-col md:flex-row-reverse gap-10 items-center">
        {/* Left: Narrative */}
        <div data-aos="fade-left" className="md:w-2/3 bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-white/10 shadow-lg shadow-blue-900/80">
